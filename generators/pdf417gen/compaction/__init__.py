...
from .. compaction import optimizations
from .. compaction.byte import compact_bytes
from .. compaction.numeric import compact_numbers
from .. compaction.text import compact_text
